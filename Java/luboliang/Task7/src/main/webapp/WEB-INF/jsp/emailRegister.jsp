...
<div style="width:100%;text-align:center">
    ...
    <form id="sighupForm" action="/register" method="post" onsubmit="formCheck()">
        ...
        用户名：
        <input type="text" name="user" required pattern="^[a-zA-Z0-9]{6,12}$" placeholder="英文或者数字,长度6到12位"
               style="width: 200px;height: 35px"><br>

        密码：
        <input type="text" name="password" required pattern="^[a-zA-Z0-9]{6,12}$" id="pwd1" placeholder="英文或者数字,长度6到12位"
               style="width: 200px;height: 35px"><br>
        重复密码：
    ...
    <a href="/register" class="btn">使用手机号注册</a>
